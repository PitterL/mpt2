/*============================================================================
Filename : qtm_acq_t1617_0x001b_api.h
...
*/
typedef struct {
	uint16_t grp4_x_mask[4];    /* Selects the X Pins for this parallel node group */
	uint16_t grp4_ymask;        /* Selects the Y Pins for this parallel node group */
...
typedef struct {
	...
	qtm_acq_4p_t161x_config_t *  qtm_acq_node_config;
