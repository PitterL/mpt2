...
/*! \brief configure the touch port pins to Input
 */
/* static */void touch_sensor_pin_config(void);
...
/* Node Container */
qtm_acquisition_control_t qtlib_acq_set1 = {&qtm_acq_gen1, &qtm_seq_node_cfg1[0], &qtm_node_stat1[0]};
...
static void touch_module_config(void)
{
  ...
  /* register rtc timer interrupt handler */
...
uint16_t get_next_measurement_period(uint16_t current)
{
  ...
  wdt_period = wdt_get_period_value();
  if (wdt_period) {
