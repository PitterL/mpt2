 ...
 */
void api_pinfault_set_param(void)
{
	ADC_disable(&ADC0);
	ADC_disable(&ADC1);
 ...
 */
uint8_t api_pinfault_test(uint8_t delay,uint8_t thld, uint8_t *test_pin, uint8_t *test_val)
{
	uint8_t result;
	uint8_t seq = 0;

	api_pinfault_set_param();
