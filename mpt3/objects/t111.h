...
#define API_NODE_PARAMS_RESISTOR_PRESCALER NAPI_NODE_PARAMS_RESISTOR_PRESCALER
#define API_NODE_PARAMS_ADC_OVERSAMPLING NAPI_NODE_PARAMS_ADC_OVERSAMPLING
