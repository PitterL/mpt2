...
#define API_SURFACE_CS_POS_HYST NAPI_SURFACE_CS_POS_HYST
#define API_SURFACE_CS_FILT_CFG NAPI_SURFACE_CS_FILT_CFG
#define API_SURFACE_CS_MIN_CONTACT NAPI_SURFACE_CS_MIN_CONTACT

#define API_SURFACE_CS_START_KEY_V	NAPI_SURFACE_CS_START_KEY_V
#define API_SURFACE_CS_NUM_KEYS_V		NAPI_SURFACE_CS_NUM_KEYS_V
#define API_SURFACE_CS_START_KEY_H	NAPI_SURFACE_CS_START_KEY_H
#define API_SURFACE_CS_NUM_KEYS_H		NAPI_SURFACE_CS_NUM_KEYS_H
#define API_SURFACE_CS_RESOL_DB	NAPI_SURFACE_CS_RESOL_DB
